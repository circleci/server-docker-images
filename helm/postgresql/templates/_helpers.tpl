...
{{- if eq .Values.architecture "replication" }}
    {{- printf "%s-primary" (include "common-v1.names.fullname" .) | trunc 63 | trimSuffix "-" -}}
{{- else -}}
...
{{- printf "%s-read" (include "common-v1.names.fullname" .) | trunc 63 | trimSuffix "-" -}}
{{- end -}}
...
{{- else -}}
    {{- printf "%s" (include "common-v1.names.fullname" .) -}}
{{- end -}}
{{- end -}}
...
{{- if .Values.serviceAccount.create -}}
    {{ default (include "common-v1.names.fullname" .) .Values.serviceAccount.name }}
{{- else -}}
...
{{- if .Values.tls.autoGenerated }}
    {{- printf "%s-crt" (include "common-v1.names.fullname" .) -}}
{{- else -}}
