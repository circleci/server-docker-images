...
kind: ConfigMap
metadata:
  name: {{ include "common-v2.names.fullname" . }}
data:
  myvalue: "Hello World"
```
...
metadata:
  name: {{ include "common-v2.names.fullname" . }}
  labels:
    app: {{ include "common-v2.names.fullname" . }}
type: Opaque
data:
...
...
      env:
        - name: PASSWORD
          valueFrom:
            secretKeyRef:
              name: {{ include "common-v2.secrets.name" (dict "existingSecret" .Values.existingSecret "context" $) }}
              key: {{ include "common-v2.secrets.key" (dict "existingSecret" .Values.existingSecret "key" "password") }}
...
...
{{ include "common-v2.validations.values.multiple.empty" (dict "required" (list $validateValueConf00 $validateValueConf01) "context" $) }}
```
